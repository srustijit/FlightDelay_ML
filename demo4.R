...
origData <- read.csv('37379696_T_ONTIME.csv', sep=",", header=TRUE, stringsAsFactors = FALSE)
...
# Convert Delay Columns NAs to 0

onTimeData[is.na(onTimeData)] <- 0
...
featureCols <- c("ARR_DEL15", "DAY_OF_WEEK", "CARRIER", "DEST","ORIGIN","DEP_TIME_BLK","CARRIER_DELAY","WEATHER_DELAY","NAS_DELAY","SECURITY_DELAY","LATE_AIRCRAFT_DELAY")
